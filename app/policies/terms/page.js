      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="space-y-6 text-gray-700">
          <section>
            ...
            <p>
              By accessing and using www.nandikajewellers.in, you accept and agree to be bound by 
          ...
          <section>
            ...
            <p>
              ...
              reliable, current, or error-free. Colors may vary slightly due to photography and 
              screen settings.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">4. Pricing and Availability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">5. Order Processing</h2>
            <p>
              By placing an order, you are making an offer to purchase the product(s). We reserve 
              the right to accept or decline your order for any reason. Order confirmation does not 
          ...
          <section>
            ...
            <p>
              Payment must be made in full at the time of purchase. We accept payments through 
              Razorpay, which supports credit cards, debit cards, UPI, net banking, and wallets. 
              All transactions are secure and encrypted.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">7. Authenticity and Quality</h2>
            <p>
              All jewellery sold on our website is authentic and of the highest quality. We provide 
              certificates of authenticity for precious metal and gemstone jewellery upon request.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              is the property of Nandika Jewellers and is protected by copyright laws. Unauthorized 
              use is prohibited.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Nandika Jewellers shall not be liable for any indirect, incidental, special, or 
          ...
          <section>
            ...
            <p className="mt-2">
              Email: <a href="mailto:support@nandikajewellers.in" className="text-blue-600 hover:underline">support@nandikajewellers.in</a>
            </p>
          </section>
        </div>
      </div>
